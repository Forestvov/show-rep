...
export const AsideIconDocActive: FC = () => {
	return (
		<svg width='16' height='20' viewBox='0 0 16 20' fill='none' xmlns='http://www.w3.org/2000/svg'>
			<path
				...
				fill='url(#paint0_linear_1_552)'
			/>
			<defs>
				<linearGradient id='paint0_linear_1_552' x1='8' y1='0' x2='8' y2='34.1176' gradientUnits='userSpaceOnUse'>
